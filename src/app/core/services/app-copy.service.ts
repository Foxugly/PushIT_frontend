...
const APP_COPY = {
  fr: {
    ...
    forgotPassword: {
      ...
      description:
        'Saisissez votre email. Si un compte existe, nous vous enverrons un lien pour reinitialiser votre mot de passe.',
      email: 'Email',
      submit: 'Continuer',
      submitted:
        'Si un compte existe avec cet email, un lien de reinitialisation vient de vous etre envoye. Pensez a verifier vos spams.',
